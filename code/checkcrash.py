...
def checkcrash(aligned_cngc_path,min_crash_path):
    print('[2/4] Selecting suitable linker conformations...')
    ...
    #print(len(pe),len(le))
        ...
        if crash<mincrash:
            mincrash=crash
            minname=o
    shutil.copy(aligned_cngc_path+'/'+minname,min_crash_path+'/'+minname)

checkcrash('../data/02_tmalignresult_all','../data/03_mincrashpdb')